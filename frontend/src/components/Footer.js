        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold">Descripto</h3>
                <p className="text-gray-400 text-sm">AI-Powered Descriptions</p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#integrations" className="text-gray-400 hover:text-white transition-colors duration-200">
                  Integrations
                </a>
              </li>
            </ul>
